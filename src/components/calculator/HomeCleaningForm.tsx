...
const cleaningPrices = [
  {
    minKvm: 10,
    maxKvm: 70,
    prices: { fourth_week: 950, biweekly: 1350, weekly: 2300, once: 5400 },
    petFee: 200,
  },
  {
    minKvm: 71,
    maxKvm: 99,
    prices: { fourth_week: 1050, biweekly: 1650, weekly: 3200, once: 5400 },
    petFee: 200,
  },
  {
    minKvm: 100,
    maxKvm: 115,
    prices: { fourth_week: 1150, biweekly: 1950, weekly: 3600, once: 5400 },
    petFee: 200,
  },
  {
    minKvm: 116,
    maxKvm: 129,
    prices: { fourth_week: 1250, biweekly: 2100, weekly: 4200, once: 5400 },
    petFee: 200,
  },
  {
    minKvm: 130,
    maxKvm: 159,
    prices: { fourth_week: 1400, biweekly: 2400, weekly: 4600, once: 5400 },
    petFee: 300,
  },
  {
    minKvm: 160,
    maxKvm: 179,
    prices: { fourth_week: 1650, biweekly: 2600, weekly: 5000, once: 5400 },
    petFee: 300,
  },
  {
    minKvm: 180,
    maxKvm: 199,
    prices: { fourth_week: 1800, biweekly: 3000, weekly: 5400, once: 5400 },
    petFee: 300,
  },
  {
    minKvm: 200,
    maxKvm: 219,
    prices: { fourth_week: 2000, biweekly: 3300, weekly: 5800, once: 5400 },
    petFee: 300,
  },
  {
    minKvm: 220,
    maxKvm: 239,
    prices: { fourth_week: 2150, biweekly: 3550, weekly: 6100, once: 5400 },
    petFee: 300,
  },
];
