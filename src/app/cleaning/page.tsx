    ...
    <main className='lg:pt-48'>
      ...
      <div className='w-full px-4 sm:px-8 lg:px-28 pt-48 p-4 sm:p-6 lg:p-8 '>
        ...
        <p className='text-lg lg:text-center text-gray-700 dark:text-gray-300 max-w-2xl mx-auto'>
          Fyll i formuläret för att boka din städning. Vi erbjuder professionell
          hemstädning anpassad efter dina behov.
        </p>
      </div>
          ...
          <div className='space-y-2'>
            ...
            >
              <ul className='list-disc pl-5 space-y-1'>
                ...
                <li>
                  Om ni kan förse oss med en fotpall hjälper det oss att nå
                  högre
                </li>
                <li>
