    ...
    <main className='lg:pt-48'>
      ...
      <div className='w-full px-4 sm:px-8 lg:px-28 pt-48 p-4 sm:p-6 lg:p-8 '>
        ...
        <p className='text-lg lg:text-center text-gray-700 dark:text-gray-300 max-w-2xl mx-auto'>
          Fyll i formuläret för att boka din flyttstädning. Vi erbjuder grundlig
          och professionell flyttstädning anpassad efter dina behov.
        </p>
      </div>
          ...
          <div className='space-y-2'>
            ...
            >
              <ul className='grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 pl-4'>
                ...
                <li className='list-disc text-sm'>
                  Rengöring av toalettstolen.
                </li>
                <li className='list-disc text-sm'>
                  Utvändig rengöring av vitvaror samt i tvättmedels behållaren
                  på tvättmaskinen.
                </li>
                <li className='list-disc text-sm'>
