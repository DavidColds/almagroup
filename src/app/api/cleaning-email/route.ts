...
export async function POST(req: NextRequest) {
  ...
  const mailOptions = {
    ...
    subject: 'Ny bokning av hemstädning',
    html: `
      <div style="max-width:520px;margin:0 auto;background:#f9f9f9;border-radius:10px;padding:32px 24px;font-family:sans-serif;color:#222;">
        <div style="text-align:center;">
          ...
          <h2 style="color:#1a202c;margin-bottom:8px;">Ny bokning av hemstädning</h2>
        ...
        <div style="background:#fff;border-radius:8px;padding:20px 16px;margin-bottom:24px;">
          <table style="width:100%;font-size:16px;color:#222;">
            ...
            <tr>
              <td style="padding:6px 0;"><strong>Frekvens:</strong></td>
              <td style="padding:6px 0;">${data.frequency}</td>
            </tr>
            <tr>
          ...
          ${
            data.extraMessage
              ? `<div style="margin-top:18px;">
                  ...
                  <p style="margin:0;color:#444;">${data.extraMessage}</p>
                </div>`
              : ''
          }
        </div>
        ...
        <div style="max-width:520px;margin:0 auto;background:#f9f9f9;border-radius:10px;padding:32px 24px;font-family:sans-serif;color:#222;">
          ...
          <div style="background:#fff;border-radius:8px;padding:20px 16px;margin-bottom:24px;">
            ...
            <ul style="margin:0;color:#444;padding-left:18px;">
              ...
              <li><strong>Frekvens:</strong> ${data.frequency}</li>
